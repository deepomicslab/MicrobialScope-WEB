...
const secondaryMetabolitesLinearLayout = (shared) => {
    ...
    const secondaryMetabolitesYBase = proteinsYBase - vizConfig.secondaryMetabolites.gap - vizConfig.secondaryMetabolites.arrowWidth / 2
...
export default secondaryMetabolitesLinearLayout
