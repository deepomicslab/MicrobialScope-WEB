...
const CRISPRCasLinearLayout = (shared) => {
    ...
    const CRISPRCasYBase = proteinsYBase - vizConfig.CRISPRCas.gap - vizConfig.CRISPRCas.arrowWidth / 2
...
export default CRISPRCasLinearLayout
