...
const tRNALinearLayout = (shared) => {
    ...
    const signalPeptideYBase = proteinsYBase - vizConfig.signalPeptide.gap - vizConfig.signalPeptide.arrowWidth / 2
...
export default tRNALinearLayout
