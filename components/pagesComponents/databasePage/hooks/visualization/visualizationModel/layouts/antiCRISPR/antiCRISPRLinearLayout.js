...
const antiCRISPRLinearLayout = (shared) => {
    ...
    const antiCRISPRYBase = proteinsYBase - vizConfig.antiCRISPR.gap - vizConfig.antiCRISPR.arrowWidth / 2
...
export default antiCRISPRLinearLayout
