...
const addStartAndEndToSp = (spList, proteinList) => {
...
const AnnotatedSignalPeptideMapViz = forwardRef(({ fastaDetail, proteins, signalPeptides }, ref) => {
    ...
    const signalPeptidesViz = useMemo(() => {
        return addStartAndEndToSp(signalPeptides, proteins)
    }, [proteins, signalPeptides])
            ...
            >
                <svg ref={svgRef} width={svgWidth} height={svgHeight} id='test-svg'>
                    ...
                    <SignalPeptideArc
                        ...
                        cy={cy}
                        radicalScale={radicalScale}
                        radius={MapVizConfig.signalPeptide.radius}
                        signalPeptides={signalPeptidesViz}
                        arrowWidth={MapVizConfig.signalPeptide.arrowWidth}
                        toolTipRef={toolTipRef}
                    />
                    <AreaPlot
                        width={MapVizConfig.areaPlot.width}
