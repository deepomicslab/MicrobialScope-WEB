...
const AnnotatedAntiCRISPRMapViz = forwardRef(({ fastaDetail, proteins, antiCRISPR }, ref) => {
            ...
            >
                <svg ref={svgRef} width={svgWidth} height={svgHeight} id='test-svg'>
                    ...
                    <AntiCRISPRArc
                        ...
                        cy={cy}
                        radicalScale={radicalScale}
                        radius={MapVizConfig.antiCRISPR.radius}
                        antiCRISPR={antiCRISPR}
                        arrowWidth={MapVizConfig.antiCRISPR.arrowWidth}
                        toolTipRef={toolTipRef}
                    />
                    <AreaPlot
                        width={MapVizConfig.areaPlot.width}
