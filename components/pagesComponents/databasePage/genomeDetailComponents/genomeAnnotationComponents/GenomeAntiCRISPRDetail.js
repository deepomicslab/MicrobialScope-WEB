...
import {
    AntiCRISPRAnnotationModalDetailDescriptions, AntiCRISPRAnnotationModalDetailTitle
                ...
                filteredAntiCRISPR.length > 0 ? (
                    <>
                        <Stack spacing={2}>
                            ...
                            >
                                Anti-CRISPR Element Annotation
                            </H6>
                            <Stack>
                                <H6 sx={{ fontSize: '28px', mt: '12px', mb: '36px' }}>
                                    Anti-CRISPR Element List
                                </H6>
                                <StyledTable
                                    columns={columns}
                            ...
                            <Stack spacing={2}>
                                <Stack direction='row' spacing={6} alignItems="center">
                                    <H6 sx={{ fontSize: '28px', mt: '12px', mb: '36px' }}>
                                        Annotated Anti-CRISPR Element Map
                                    </H6>
                        ...
                        <DraggableModal
                            ...
                            title={<AntiCRISPRAnnotationModalDetailTitle/>}
                        >
                            <Box
                                sx={{
                                    px: '8px',
                            ...
                            >
                                <AntiCRISPRAnnotationModalDetailDescriptions record={selectedRecord} microbe={microbe}/>
                            </Box>
                        </DraggableModal>
                    </>
                ) : (
