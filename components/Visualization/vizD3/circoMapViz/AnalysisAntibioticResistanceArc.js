...
import {
    ...
    extractAntibioticResistanceArrowData
...
const AnalysisAntibioticResistanceArc = ({
    cx,
    cy,
    radicalScale,
    radius,
    ...
    const processedAntibioticResistance = useMemo(() => {
        return extractAnalysisAntibioticResistanceArrowData(antibioticResistance)
    }, [antibioticResistance])
    ...
    const showTooltip = (event, antibioticResistance) => {
        toolTipRef.current.showTooltip(event, AnalysisAntibioticResistanceTooltipTemplate(antibioticResistance))
    }
...
export default AnalysisAntibioticResistanceArc
